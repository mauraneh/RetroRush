      ...
      return (
        <div className="expansionPanel">
          ...
          <p className="gameTagline">
            Faites rebondir la balle, détruisez les briques, et ne laissez pas
            la balle tomber !
          </p>
          ...
          <div className="sliderContainer">
            <label htmlFor="speed-range" className="speedRangeText">
              Indiquez la vitesse de la balle, et lancez !
            </label>
            <input
              id="sliderInput"
              type="range"
          ...
          <div className="instructions">
            <div className="instructionsHomePages">
              <p className="pHomePage">
                Découvrez un univers de jeux rétro et plongez dans le plaisir
                nostalgique ! <br />
              ...
              <div className="buttonList">
                ...
                <button
                  className="button"
                  onClick={() => navigate(selectRandomGame())}
                >
                  Jeux aléatoire
                </button>
              </div>
